...
import { Mail, Lock, ArrowLeft, Car, AlertCircle } from "lucide-react";
...
/**
 * UserLogin - Pantalla de Login de Usuario Estilo Uber
 */
function UserLogin() {
  ...
  const loginUser = async (data) => {
    if (data.email.trim() !== "" && data.password.trim() !== "") {
      try {
        ...
        showToast.success("¡Bienvenido! Sesión iniciada exitosamente");
        navigation("/home");
      } catch (error) {
